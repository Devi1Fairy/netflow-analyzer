                     ...
                     uint32_t wire_length)
{
    ...
    new_info = (packet_info_t){
        ...
        .has_ipv4 = false,
        .ipv4_header_length = UINT8_C(0),
        .ipv4_total_length = UINT16_C(0),
        .ipv4_identification = UINT16_C(0),
        .ipv4_dont_fragment = false,
        .ipv4_more_fragments = false,
        .ipv4_fragment_offset = UINT16_C(0),
        .ipv4_ttl = UINT8_C(0),
        .ipv4_protocol = UINT8_C(0),
        .ipv4_header_checksum = UINT16_C(0),
        .source_ipv4 = UINT32_C(0),
        .destination_ipv4 = UINT32_C(0),
        .ipv4_payload_offset = 0U,
        .ipv4_payload_length = 0U,
        .ipv4_payload_truncated = false,
        .has_tcp = false,
        .tcp_source_port = UINT16_C(0),
        .tcp_destination_port = UINT16_C(0),
        .tcp_sequence_number = UINT32_C(0),
        .tcp_acknowledgment_number = UINT32_C(0),
        .tcp_header_length = UINT8_C(0),
        .tcp_flags = UINT16_C(0),
        .tcp_window_size = UINT16_C(0),
        .tcp_checksum = UINT16_C(0),
        .tcp_urgent_pointer = UINT16_C(0),
        .tcp_payload_offset = 0U,
        .tcp_payload_length = 0U,
        .tcp_payload_truncated = false,
        .has_udp = false,
        .udp_source_port = UINT16_C(0),
        .udp_destination_port = UINT16_C(0),
        .udp_length = UINT16_C(0),
        .udp_checksum = UINT16_C(0),
        .udp_payload_offset = 0U,
        .udp_payload_length = 0U,
        .udp_payload_truncated = false,
        .has_icmp = false,
        .icmp_type = UINT8_C(0),
        .icmp_code = UINT8_C(0),
        .icmp_checksum = UINT16_C(0),
        .icmp_rest_of_header = UINT32_C(0),
        .icmp_has_echo_fields = false,
        .icmp_identifier = UINT16_C(0),
        .icmp_sequence = UINT16_C(0),
        .icmp_payload_offset = 0U,
        .icmp_payload_length = 0U,
        .icmp_payload_truncated = false,
